...
public class Game extends JApplet implements Runnable, KeyListener {
    ...
    public AudioClip loadMusic(String name) {
    	...
    	try {
    	    ...
    	    File musicFile = new File("resources" + File.separator + "LevelOne-Music-" + name +".wav");
    	    musicURL = musicFile.toURI().toURL();
			
		} catch (MalformedURLException e) {
		}
		
		// TODO This nothing that i've coded is null it's the method.
		AudioClip clip = newAudioClip(musicURL); 
